    ...
    return (
        <div className='max-w-[1280px] mx-auto px-6 lg:px-0 grid gap-5 pt-8 pb-14 text-center justify-center'>
            ...
            <p className="text-xl md:text-2xl my-3">
                Opps! The page <code className='clr-secondary font-bold'>{location.pathname}</code> you're looking for doesn't exist.
            </p>
            <Link to="/" className="px-8 py-3 btn text-lg font-semibold rounded clr-primary-bg">Go to Home</Link>
        </div>
    );
};
